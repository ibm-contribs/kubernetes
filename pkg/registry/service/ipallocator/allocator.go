...
// List of new error types generated by the ipallocator package
var (
...
type Range struct {
	...
	max int
	// suppressServiceClusterIPRangeEnforcement is the flag to turn off ip range enforcement
...
func NewAllocatorCIDRRange(cidr *net.IPNet, suppressServClusterIPRangeEnforcement bool, allocatorFactory allocator.AllocatorFactory) *Range {
	max := RangeSize(cidr)
	...
	r := Range{
		...
		suppressServiceClusterIPRangeEnforcement: suppressServClusterIPRangeEnforcement,
	}
...
func NewCIDRRange(cidr *net.IPNet, suppressServClusterIPRangeEnforcement bool) *Range {
	return NewAllocatorCIDRRange(cidr, suppressServClusterIPRangeEnforcement, func(max int, rangeSpec string) allocator.Interface {
...
func (r *Range) Allocate(ip net.IP) error {
	...
	if !ok {
		if r.suppressServiceClusterIPRangeEnforcement {
			return nil
		}
